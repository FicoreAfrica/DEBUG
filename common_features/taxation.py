...
def calculate_tax():
    ...
    if form.validate_on_submit():
        ...
        if tax_rate:
            ...
            return render_template('common_features/taxation/calculation_result.html', tax=tax, explanation=explanation, amount=amount)
        else:
            flash('No tax rate found for your role and amount', 'warning')
    return render_template('common_features/taxation/calculate.html', form=form, role=current_user.role)
...
def payment_info():
    ...
    return render_template('common_features/taxation/payment_info.html', locations=locations)
...
def reminders():
    ...
    return render_template('common_features/taxation/reminders.html', reminders=reminders)
...
def manage_payment_locations():
    ...
    return "Manage Payment Locations (Admin)"
...
def manage_tax_deadlines():
    ...
    return "Manage Tax Deadlines (Admin)"